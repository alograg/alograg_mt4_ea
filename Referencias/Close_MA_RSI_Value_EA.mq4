...
int start() {
  ...
  if (TotalOrdersCount() == 0) {
    int result = 0;
    if ((Close[1] > iMA(NULL, 0, 10, 0, MODE_SMA, PRICE_CLOSE, 1)) &&
        (iRSI(NULL, 0, 14, PRICE_CLOSE, 1) > 70)) // Here is your open buy rule
    {
      result =
    ...
    if ((Close[1] < iMA(NULL, 0, 14, 0, MODE_SMA, PRICE_CLOSE, 1)) &&
        (iRSI(NULL, 0, 14, PRICE_CLOSE, 1) < 40)) // Here is your open Sell rule
    {
      result =
