...
/*
Diseñado para trabajar en gráficos de 1 minuto en el par EURGBP, este EA puede trabajar con cualquier cruce de la Libra. También funciona en gráficos de 5 y 15 minutos, si bien el autor señala que siempre prefiere los gráficos de 1 minuto, indicando claramente que es su estrategia de scalping, que no tiene por qué servir a todos los traders.

El scalping, una estrategia que consiste en aprovechar pequeños movimientos del precio, requiere tener una mente y unas manos rápidas, por lo que probablemente usar este EA es la mejor forma de evitar las dudas y perder las oportunidades.

Tenga en cuenta que debemos tener datos históricos en un 1 minuto descargados y completo para que este EA funcione correctamente, tal y como se explica aquí:

- Download Historical Data for Metatrader 4 (http://www.forexstreet.net/group/metatrader/forum/topics/download-historical-data-for-1)
- Strategy Tester Mismatched chart errors (http://www.forexstreet.net/group/metatrader/forum/topics/strategy-tester-mismatched)

Recomiendo encarecidamente probar este EA antes de usarlo en cuentas reales, y usarlo en gráficos de 5 minutos, donde también trabaja bastante bien, evitando la extrema volatilidad del gráfico de 1 minuto, y siendo muy cuidadoso con los stops de pérdidas.
*/
