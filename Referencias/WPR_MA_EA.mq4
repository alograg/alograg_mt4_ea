...
int start()
{
  ...
  {
     int result=0;
     if((iWPR(NULL,PERIOD_D1,1,1)<iWPR(NULL,PERIOD_D1,1,0))&&(iWPR(NULL,PERIOD_H1,1,0)>iMA(NULL,PERIOD_H1,1,14,MODE_SMA,PRICE_CLOSE,0))&&(Low[0]<iADX(NULL,PERIOD_M15,14,PRICE_LOW,MODE_MAIN,0))) // Here is your open buy rule
     {
     ...
     if((iWPR(NULL,PERIOD_D1,1,1)>iWPR(NULL,PERIOD_D1,1,0))&&(iWPR(NULL,PERIOD_H1,1,0)<iMA(NULL,PERIOD_H1,14,0,MODE_SMA,PRICE_CLOSE,0))&&(High[0]<iADX(NULL,PERIOD_M15,14,PRICE_HIGH,MODE_MAIN,0))) // Here is your open Sell rule
     {
